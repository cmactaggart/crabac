...
import { CheckCheck, AtSign, Reply, Zap, Tag, Users, Mail, CalendarX, CalendarPlus, Calendar, MessageCircle, BookOpen, Smile, UserCheck } from 'lucide-react';
...
function getNotificationIcon(type: string) {
  switch (type) {
    ...
    case 'event_organizer_needed': return <UserCheck size={16} style={{ color: '#fab005' }} />;
