...
import { registerFollowsGateway } from './modules/follows/follows.gateway.js';
import { forumsRoutes } from './modules/forums/forums.routes.js';
import { calendarRoutes } from './modules/calendar/calendar.routes.js';
import { publicMeetingRoutes } from './modules/calendar/public-meeting.routes.js';
...
import { newsletterRoutes, personalNewsletterRoutes } from './modules/newsletter/newsletter.routes.js';
...
import { registerBlogListener } from './modules/blog/blog.listener.js';
...
app.use('/api/spaces', newsletterRoutes);
app.use('/api/users', personalNewsletterRoutes);
app.use('/api/newsletter-subscriptions', newsletterSubscriptionRoutes);
app.use('/api/newsletter-public', newsletterPublicRoutes);
app.use('/api/newsletter-track', newsletterTrackingRoutes);
app.use('/api/boards', publicBoardLimiter, boardsRoutes);
app.use('/api/public', publicBoardLimiter, publicMeetingRoutes);
